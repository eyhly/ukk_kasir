				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							...
							<button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d['PetugasID']; ?>">
								Edit
							</button>
							<?php 
							if ($d['level'] == $_SESSION['level']) { ?>
							<?php } else { ?>
								<button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-data<?php echo $d['PetugasID']; ?>">
									Hapus
								</button>
							<?php } ?>
						</td>
					...
					<!-- Modal Edit Data-->
					<div class="modal fade" id="edit-data<?php echo $d['PetugasID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								...
								<form action="proses_update_petugas.php" method="post">
									<div class="modal-body">
										<div class="form-group">
											...
											<input type="hidden" name="id_petugas" value="<?php echo $d['PetugasID']; ?>">
											<input type="text" name="nama_petugas" class="form-control" value="<?php echo $d['NamaPetugas']; ?>">
										</div>
										<div class="form-group">
					...
					<!-- Modal Hapus Data-->
					<div class="modal fade" id="hapus-data<?php echo $d['PetugasID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
